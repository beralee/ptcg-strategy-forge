...
2026-09-08 的[下一阶段研发迭代提案](20-DEVELOPER-ITERATION-ARCHITECTURE-AND-PLAN.md) 另行提出可选的本地 BC 基线训练器、录像数据与实验编排。这是对后续开发工具范围的有限扩展，尚未实施；本页“首代 v2 不提供训练循环”的当前边界与 data-only 玩家运行合同继续有效。
